...
const struct prefix_t gs1_prefix[] = {
{1, 19, "GS1 US"},
{20, 29, "Restricted distribution"},
{30, 39, "GS1 US"},
{40, 49, "Restricted distribution"},
{50, 59, "GS1 US reserved for future use"},
{60, 139, "GS1 US"},
...
{385, 385, "GS1 Croatia"},
{387, 387, "GS1 Bosnia and Herzegovina"},
...
{951, 951, "Global Office - General Manager Number, see Note 2"},
...
{99, 99, "GS1 coupon identification"}
};

#define GS1_PREFIX_COUNT (sizeof(gs1_prefix) / sizeof(gs1_prefix[0]))
